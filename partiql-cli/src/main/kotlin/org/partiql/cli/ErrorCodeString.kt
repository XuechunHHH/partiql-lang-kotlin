...
enum class ErrorCodeString(val code: Int) {
    ...
    SET_OP_SCHEMA_INCOMPATIBLE(PError.SET_OP_SCHEMA_INCOMPATIBLE),
    NOT_IMPLEMENTED(PError.NOT_IMPLEMENTED),
    MAP_KEY_NOT_FOUND(PError.MAP_KEY_NOT_FOUND),
    MAP_KEY_TYPE_MISMATCH(PError.MAP_KEY_TYPE_MISMATCH),
    MAP_DUPLICATE_KEY(PError.MAP_DUPLICATE_KEY),
}
