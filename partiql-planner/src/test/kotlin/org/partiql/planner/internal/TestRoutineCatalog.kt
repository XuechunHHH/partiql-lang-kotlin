...
internal class TestRoutineCatalog private constructor(
    ...
    internal class Builder(private val name: String) {
        ...
        internal fun function(
            ...
            functions += RoutineBinding(RoutineId(providerId), canonicalName, overloads.toList())
        }
        ...
        internal fun aggregation(
            ...
            aggregations += RoutineBinding(RoutineId(providerId), canonicalName, overloads.toList())
        }
